...
?>
	...
	<footer id="colophon" class="site-footer text-center" style="background-color: <?php echo $footerBgColor; ?>">
		...
		<div class="site-info <?php echo $contentwidth; ?> py-3">
			<hr>
			<div class="copy-right-footer" style="color: <?php echo $footerParghColor; ?>; font-size: 11px;">© Copyright 2023 <?php echo $blog_info; ?> | <a href="<?php echo home_url(); ?>/terms-and-conditions/">Terms &amp; Conditions</a> | <a href="<?php echo home_url(); ?>/privacy-policy/">Privacy Policy</a> | Made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="<?php echo $developedbyurl; ?>" target="_blank" rel="noopener"><?php echo $developedby; ?></a></div>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
</div><!-- #page -->
